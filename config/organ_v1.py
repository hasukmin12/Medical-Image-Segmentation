...
save_name = 'caddunet_focal_portion_drop0.1_b4_e10_img512'

info = {
    "TARGET_NAME"   : "multi_organ_model",
    "VERSION"       : 1,
    "FOLD"          : 4,
    "FOLDS"         : 5, 
    "ROOT"          : "/nas3/sukmin/datasets/Task002_Multi_Organ",
    "CHANNEL_IN"    : 1,
    "CHANNEL_OUT"   : 6,
    "CLASS_NAMES"   : {1:'Liver',2:'Stomach',3:'Pancreas',4:'Gallbladder',5:'Spleen'},   
    #### wandb
    "ENTITY"        : "has_in_tom",
    "PROJ_NAME"     : "multi_organ",
